...
- Key data tables:
  ...
  - `behavior_pnr` — booking-level data (PNR records, status, trip reason)
  - `behavior_pnr_leg` — individual flight legs (cabin, carrier, route)
  - `behavior_pnr_leg_anc` — ancillary purchases (seats, bags, upgrades, lounges)
